        ...
        <form action="./php/register.php" method="POST" id="registerForm">
          ...
          <div class="login-info">
            ...
            <div class="password-container">
              ...
              <svg class="eye-hide" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
              ...
              <svg class="eye-show" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                width="24px" fill="#0011ff">
                <path
...
<script>
  ...
  const eyeShow = document.querySelectorAll(".eye-show");
  const eyeHide = document.querySelectorAll(".eye-hide");
  eyeShow.forEach(eye => {
    eye.addEventListener("click", () => {
      const input = eye.parentElement.querySelector("input");
      input.type = "text";
      eye.style.display = "none";
      eye.parentElement.querySelector(".eye-hide").style.display = "inline-block";
    });
  });
  eyeHide.forEach(eye => {
    eye.addEventListener("click", () => {
      ...
      input.type = "password";
      eye.style.display = "none";
      eye.parentElement.querySelector(".eye-show").style.display = "inline-block";
    });
  });
