  ...
  <body>
    <nav>
      ...
      <div id="trainer-profile">
        <img src="" />
        <h3 class="name">Ruby X. Cube</h3>
        <p>Trainee</p>
        <p class="trainer-id-number">123456789</p>
      </div>
      <div id="navigation">
        <ul>
          <li><a class="dashboard active" href="#dashboard">Dashboard</a></li>
          <li>
            <a class="enrollment-request" href="#enrollment-request"
              >Enrollment Requests</a
            >
          </li>
          <li><a class="courses" href="#courses">My Courses</a></li>
          <li>
            <a class="activities-modules" href="#activities-modules"
              >Activities & Modules</a
            >
          </li>
                ...
                <tr>
                  ...
                  <td>
                    <button
                      type="button"
                      id="stateBtn"
                      style="background-color: #006aff; color: white"
                    >
                      Enabled
                    </button>
                  </td>
          ...
          <div class="container">
            <form action="" class="uploadActForms">
              ...
              <div class="addModule">
                <label
                  >Module Title
                  <input type="text" name="moduleTitle" id="moduleTitle"
                /></label>
            ...
            <form class="capsule">
              ...
              <div class="details">
                ...
                <textarea
                  ...
                  "
                >
Certified Instructor With Masters Degree for Agriculture.</textarea
                >
